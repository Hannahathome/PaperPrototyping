...
class ShapeSpec {
  ...
  // them would let two shapes share one rig list -- the same trap deepCopyEdgeProfile()
  // exists to avoid. The frame is reached as shapes.get(i).frame and edited in place.
  FrameSpec frame;
