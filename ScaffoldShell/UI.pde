...
void updateSidebarControlsVisibility() {
  ...
  boolean shapeVisible = (activeTab == MAIN_TAB_SHAPE);
  ...
  boolean viewVisible = (activeTab == MAIN_TAB_PRINT && (sidebar == null || sidebar.activePrintTab == 0));
  ...
  boolean baseVisible = (activeTab == MAIN_TAB_PRINT && sidebar != null && sidebar.activePrintTab == 2);
  {
  ...
  boolean printVisible = (activeTab == MAIN_TAB_PRINT && (sidebar == null || sidebar.activePrintTab == 0));
  ...
  boolean cutoutVisible = (activeTab == MAIN_TAB_PRINT && sidebar != null && sidebar.activePrintTab == 1);
  if (nbCutoutX != null) {
...
void controlEvent(ControlEvent e) {
  ...
  if (e.isFrom(tHollowMode)) {
    ...
    boolean shapeVisible = (sidebar.activeMainTab == MAIN_TAB_SHAPE);
...
boolean checkLidButtonPress() {
  if (sidebar == null || sidebar.activeMainTab != MAIN_TAB_PRINT) return false;
...
void setCuboidControlsVisible(boolean vis) {
  boolean inShapeTab = (sidebar == null || sidebar.activeMainTab == MAIN_TAB_SHAPE);
